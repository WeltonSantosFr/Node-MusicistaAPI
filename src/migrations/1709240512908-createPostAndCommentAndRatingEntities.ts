...
export class CreatePostAndCommentAndRatingEntities1709240512908 implements MigrationInterface {
    name = 'CreatePostAndCommentAndRatingEntities1709240512908'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rating" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" uuid, "postId" uuid, CONSTRAINT "REL_dc05a97d06394594fc882cb1e3" UNIQUE ("authorId"), CONSTRAINT "PK_ecda8ad32645327e4765b43649e" PRIMARY KEY ("id"))`);
